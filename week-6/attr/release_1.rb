...
These methods are getter and setter methods. They allow access to read
and change the instance variables of the profile object. It would
better to implement this feature with attr_accessors.

How are they modifying or returning the value of instance variables?

If the method is modifying it just sets the instance variable equal to
the argument that has been passed in. If the method is returning it,
it just returns the instance variable. I seems pretty straight forward
to me.
