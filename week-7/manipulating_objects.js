...
/* What tests did you have trouble passing? What
did you do to make it pass? Why did that work?

I Didn't have much trouble passing any of the tests. I briefly forgot
how to add to an object with out modify the literal, but once I
remembered, everything was pretty straight forward.

How difficult was it to add and delete properties outside of the
object itself?

Its pretty simple. I just used "delete objectName.propertyName" to
delete and "objectName.propertyName = value" to add.

What did you learn about manipulating objects in this challenge?

In javascript, its simple to add variables to an object outside of its
literal. It can even happen at runtime. Its just as easy to remove
properties. It seems like objects in javascript actually behave more
like hashes in ruby. I learned that when an object's attribute points
to another object, who in turn has a property that points back to the
original object, when logged to the console, for the property of the second
object that points back to the first, the console while say circular. Whew,
